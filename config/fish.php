...
return [
    ...
    'ai_review' => [
        ...
        'prompt_version' => env('FISH_AI_REVIEW_PROMPT_VERSION', 'v4'),
        'schema_version' => env('FISH_AI_REVIEW_SCHEMA_VERSION', 'v2'),
        'limits' => [
            'max_diagnostics_per_request' => (int) env('FISH_AI_REVIEW_MAX_DIAGNOSTICS_PER_REQUEST', 4),
            'max_candidates' => (int) env('FISH_AI_REVIEW_MAX_CANDIDATES', 100),
            'max_input_tokens' => (int) env('FISH_AI_REVIEW_MAX_INPUT_TOKENS', 12000),
            'max_output_tokens' => (int) env('FISH_AI_REVIEW_MAX_OUTPUT_TOKENS', 16000),
