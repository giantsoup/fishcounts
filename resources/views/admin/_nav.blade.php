<div class="border-b border-gray-200 bg-white">
    <nav class="mx-auto flex max-w-7xl gap-4 overflow-x-auto px-4 py-3 text-sm sm:px-6 lg:px-8" aria-label="Admin navigation">
        ...
        <a href="{{ route('admin.species-aliases.index') }}" class="whitespace-nowrap font-medium {{ request()->routeIs('admin.species-aliases.*') ? 'text-gray-950' : 'text-blue-700' }}">Species</a>
        <a href="{{ route('admin.trip-type-aliases.index') }}" class="whitespace-nowrap font-medium {{ request()->routeIs('admin.trip-type-aliases.*') ? 'text-gray-950' : 'text-blue-700' }}">Trips</a>
