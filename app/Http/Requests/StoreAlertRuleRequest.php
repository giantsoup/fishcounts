...
class StoreAlertRuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'recent_window_days' => ['required', 'integer', 'min:1', 'max:30'],
            'comparison_window_days' => ['required', 'integer', 'min:1', 'max:90'],
    ...
    public function ruleAttributes(): array
    {
        ...
        return [
            ...
            'recent_window_days' => $validated['recent_window_days'],
            'comparison_window_days' => $validated['comparison_window_days'],
